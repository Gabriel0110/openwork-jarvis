...
interface AppState {
  ...
  setShowHarnessView: (show: boolean) => void
...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  setShowHarnessView: (show: boolean) => {
    if (show) {
      set({
        showHarnessView: true,
        showKanbanView: false,
        showAgentsView: false,
        showGraphView: false,
        showMemoryView: false,
